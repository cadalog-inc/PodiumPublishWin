...
#define AppName "Uninstall SU2018 Podium V2.6"
#define AppVersion "1.0"
#define AppPublisher "Cadalog Inc"
#define AppURL "http://www.suplugins.com/"
#define AppExeName "Uninstall_SU2018_Podium_V2_6"
...
; Type: filesandordirs; Name: "{userappdata}\SketchUp\SketchUp 2018\SketchUp\Plugins\PodiumHDR"
...
; Type: filesandordirs; Name: "{commonappdata}\SketchUp\SketchUp 2018\SketchUp\Plugins\PodiumHDR"
...
begin
  if CurPageID = wpReady then begin
    ...
    WizardForm.ReadyLabel.Caption := ExpandConstant('Click Uninstall to remove SU Podium V2.6 Sketchup plugin from Sketchup 2018.'); 
    WizardForm.PageNameLabel.Caption := 'Ready to Uninstall';
    WizardForm.PageDescriptionLabel.Caption := 'Uninstall SU Podium V2.6 Plugin from Sketchup 2018';
  end; //begin + end to make changes only for this single page

  if CurPageID = wpFinished then begin
    WizardForm.FinishedLabel.Caption := ExpandConstant('The SU Podium V2.6 Sketchup plugin was removed from Sketchup 2018.'); 
