...
#define AppName "Uninstall SU2020 Podium V2.6"
#define AppVersion "1.0"
#define AppPublisher "Cadalog Inc"
#define AppURL "http://www.suplugins.com/"
#define AppExeName "Uninstall_SU2020_Podium_V2_6"
...
begin
  if CurPageID = wpReady then begin
    ...
    WizardForm.ReadyLabel.Caption := ExpandConstant('Click Uninstall to remove SU Podium V2.6 Sketchup plugin from Sketchup 2020.'); 
    WizardForm.PageNameLabel.Caption := 'Ready to Uninstall';
    WizardForm.PageDescriptionLabel.Caption := 'Uninstall SU Podium V2.6 Plugin from Sketchup 2020';
  end; //begin + end to make changes only for this single page

  if CurPageID = wpFinished then begin
    WizardForm.FinishedLabel.Caption := ExpandConstant('The SU Podium V2.6 Sketchup plugin was removed from Sketchup 2020.'); 
