; -- SU_Podium_V2.iss --
; Install script for  SU Podium V2.6.046 Plus

 #define AppVersion "2.6.046"

[Setup]
AppId={{F79F91FD-C2D3-4B26-87E2-AF54D6510753}
AppName= SU2020 Podium V2.6.046 Plus
AppVerName= SU2020 Podium V2.6.046 Plus {#AppVersion}
