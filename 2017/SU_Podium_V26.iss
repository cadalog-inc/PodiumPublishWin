; -- SU_Podium_V2.iss --
; Install script for  SU Podium V2.6.047 Plus

 #define AppVersion "2.6.047"

[Setup]
AppId={{F79F91FD-C2D3-4B26-87E2-AF54D6510753}
AppName= SU2017 Podium V2.6.047 Plus
AppVerName= SU2017 Podium V2.6.047 Plus {#AppVersion}
AppVersion={#AppVersion}
VersionInfoVersion={#AppVersion}
UsePreviousAppDir=no
DefaultDirName={commonappdata}\SketchUp\SketchUp 2017\SketchUp\Plugins
DirExistsWarning=no
DefaultGroupName= SU Podium V2.6.047 Plus
